...
from openprogram.programs.applications.research.pipeline import research_pipeline, STAGES
from openprogram.programs.applications.research.evaluate import compete
