...
# Base of the agentic/ package — one level up from agentic/web/
_PKG_BASE = os.path.dirname(os.path.dirname(__file__))
...
def _format_result(result, action: str = "create") -> str:
    ...
    if callable(result):
        ...
        try:
            from agentic.web.server import _broadcast as _bc
...
def _load_function(func_name: str):
    ...
    from agentic.function import auto_trace_module
